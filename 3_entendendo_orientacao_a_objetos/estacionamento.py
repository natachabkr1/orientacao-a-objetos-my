...
Vagas para carro são maiores do que as vagas para motos.
...
▹ É preciso ter controle sobre qual carro está em qual vaga para agilizar a saída quando o dono 
vem buscar.
▹ É preciso saber o número de vagas livres de carro e de moto para que o estacionamento saiba 
se pode novos carros e motos.
'''

# Atores (substantivos no singular - vão se tornar a classe): 
## estacionamento; vaga; carro; moto

# Dados - atributos (propriedades) e métodos (funções/comportamentos)
'''
Estacionamento:
...
carro_para_vaga
moto_para_vaga
vagas_livres_de_carro
vagas_livres_de_moto
